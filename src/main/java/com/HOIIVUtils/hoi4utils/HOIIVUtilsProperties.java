...
public class HOIIVUtilsProperties {
	...
	// public static final String HOI4UTILS_PROPERTIES_PATH = NEW_PROPERTIES_PATH +
	// File.separator + "HOIIVUtils";
	// static {
	...
	// private static PrintWriter settingsPWriter;// = new
	// PrintWriter(settingsBWriter); // for println syntax
	...
	// settingsFile = new File(HOI4UTILS_PROPERTIES_PATH + File.separator +
	// "HOIIVUtils_properties.txt");
	...
	// {
	// String userDocsPath = System.getProperty("user.home") + File.separator +
	// "Documents";
	// String hoi4UtilsPropertiesPath = userDocsPath + File.separator +
	// "HOIIVUtils";

	// new File(hoi4UtilsPropertiesPath).mkdir();
	// settingsFile = new File(hoi4UtilsPropertiesPath + File.separator +
	// "HOIIVUtils_properties.txt");
	...
	// */
	// public static void saveSetting(Settings setting, String settingValue) throws
	// IOException {
	// settingsWriter = new FileWriter(settingsFile, false); // true = append
	// settingsBWriter = new BufferedWriter(settingsWriter);
	// settingsPWriter = new PrintWriter(settingsBWriter);
	...
	// * @throws IOException
	// */
	// public static void saveSettings(HashMap<Settings, String> newSettings) throws
	// IOException {
	// if (newSettings == null) {
	// return;
	// }
